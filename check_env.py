#!/usr/bin/env python3
"""Print key package versions. Build uses --cpu-only; runtime can probe CUDA."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--cpu-only",
        action="store_true",
        help="Skip CUDA device smoke. Required imports must still succeed.",
    )
    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            print("CUDA not available in this process (ok if you have not selected a GPU yet)")
    except Exception as exc:
